...
{    
    const error="<h2 class='form_error_color'>Что-то пошло не так, обратитесь к разработчику системы</h2>";
    ...
    const validation_error="
            <h2 class='error'>Не все поля заполнены корректно</h2>
            <p>Проверьте правильность заполнения полей отмеченных * на всех вкладках</p>";
}
